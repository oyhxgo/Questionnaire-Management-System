          ...
          dataOption.forEach((question, index) => {
              ...
              if (question.type === '单选题' || question.type === '多选题') {
                  question.answers.forEach((option, optionIndex) => {
                      ...
                      const optionId = `${firstOptionChar + optionIndex}`;
                      if (question.type === '单选题') {
                          htmlContent += `<div class="answer"  id="${optionId}"><input type="radio">${optionChar}. ${option.text}</div>`; 
                      } else if (question.type === '多选题') {
                          htmlContent += `<div class="answer" id="${optionId}"><input type="checkbox">${optionChar}. ${option.text}</div>`;
                      }
                  });
