...
//     var questionnaireTitle = localStorage.getItem("questionnaireTitle");
...
//                             htmlContent += `<div class="option"><input type="radio">${optionChar}. ${option.text}</div>`; 
//                         } else if (question.type === 'multipleChoice') {
//                             htmlContent += `<div class="option"><input type="checkbox">${optionChar}. ${option.text}</div>`;
//                         }
//                     });
//                 } else if (question.type === 'textBook') {
//                     htmlContent += `<div class="option"><input type="text"></div>`;
//                 }
//                 htmlContent += `<br>`;
//             });
...
//         console.log("没有问卷标题");
//     }
//     document.getElementById('goindex').addEventListener('click', function () {
//         window.location.href="D:\\wenjuan\\index\\index.html"; 
